...
import nlu_dataset from './nlu_dataset.json'
...
const INITIAL_STATE = {
  filename: 'nlu_dataset.json',
  originalSource: isOnline ? nlu_dataset : null,
  examples: isOnline
    ? nlu_dataset.nlu_data.common_examples.map(e => createExample(e))
    : null,
  isUnsaved: false,
  selection: null,
...
export default function reducer (
  ...
  switch (type) {
    ...
    case FETCH_DATA: {
      ...
      return {
        ...state,
        examples: prepareExamples(data.nlu_data.common_examples),
        originalSource: data,
        filename: path,
      }
    }
